...
/* axdigi fork by Josef Matondang
 * Straight port digipeater program
 * Re-written to support latest Linux kernel with Ubuntu/Debian distro
 */
...
int main(int argc, char *argv[])
{
	...
	if (argc > 1)
	{
		...
		{
			printf("ax25-digipeater version %s. Copyright (C) 2017 Josef Matondang\n\n", VERSION);
			printf("ax25-digipeater comes with ABSOLUTELY NO WARRANTY.\n");
      ...
      printf("Based on axdigi version 0.2. Copyright (C) 1995 Craig Small VK2XLZ\n");
			return 0;
		}
	}
